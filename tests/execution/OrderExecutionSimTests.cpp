...
TEST(OrderExecutionSimTests, SubmitOrderUpdatesPosition)
{
...
TEST(OrderExecutionSimTests, ResetDoesNothingWhenFlat)
{
    TestPositionManager pm;
    OrderExecutionSim sim(pm);
...
TEST(OrderExecutionSimTests, ResetClosesLongPosition)
{
    TestPositionManager pm;
    OrderExecutionSim sim(pm);
...
TEST(OrderExecutionSimTests, ResetClosesShortPosition)
{
    TestPositionManager pm;
    OrderExecutionSim sim(pm);
